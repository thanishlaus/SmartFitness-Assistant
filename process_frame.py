    ...
    def process(self, frame: np.array, pose):
        ...
        if keypoints.pose_landmarks:
            ...
            # Camera is aligned properly.
                ...
                cv2.line(frame, (hip_coord[0], hip_coord[1] + 20), (hip_coord[0], hip_coord[1] - 80),
                         self.COLORS['blue'], 4, lineType=self.linetype)
                ...
                cv2.line(frame, (knee_coord[0], knee_coord[1] + 20), (knee_coord[0], knee_coord[1] - 50),
                         self.COLORS['blue'], 4, lineType=self.linetype)
                ...
                cv2.line(frame, (ankle_coord[0], ankle_coord[1] + 20), (ankle_coord[0], ankle_coord[1] - 50),
                         self.COLORS['blue'], 4, lineType=self.linetype)
